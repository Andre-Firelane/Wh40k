...
- the twenty-two modelled detachments' dispositions AGAINST THE CORPUS
...
checks.eq("all twenty-two modelled detachments were checked (the Mecha Orks three, G3-G5)", seen, 22)
