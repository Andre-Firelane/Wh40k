...
- the twenty-one modelled detachments' dispositions AGAINST THE CORPUS
...
checks.eq("all twenty-one modelled detachments were checked (Green Tide G3, Blitz Brigade G4)", seen, 21)
