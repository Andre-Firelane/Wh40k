...
def write_index(rows, detachment_rows=()):
    out = [
        ...
        "",
        # HAND-WRITTEN PROSE HAS TO LIVE HERE, not in rules/README.md: that file
        # is REGENERATED by this function, so a note added to it directly is
        # deleted by the next --offline run. Commit c72db33 added the paragraph
        # below by hand and a routine corpus round-trip wiped it minutes later.
