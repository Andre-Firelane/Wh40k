...
# The second Necron detachment, CANOPTEK COURT (Power Matrix - see
# game/court_power_matrix.py). Empty by default: no shipped list fields it, so
# nobody holds it until army_lists.apply_to_config() writes it from a list that
