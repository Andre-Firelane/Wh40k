...
Q:When using the Green Tide Mob Mentality detachment rule, do I switch to 6+ **InSv** partway through a unit’s attacks when the number of models in the target unit drops below 10 models?

A:
No, the number of models in the unit when it is targeted determines the unit’s **InSv** until those attacks are resolved.

Errata

Green Tide Detachment, Mob Mentality Detachment Rule
